...
class Student{
    ...
    public void setKor(int kor) {
        if (kor < 0 || kor > 100)
            throw new IllegalArgumentException("점수범위가 맞지 않습니다");
        this.kor = kor;
    }

    public void setIng(int eng) {
        this.eng = eng;
    }
...
public class ScoreProgram extends JFrame {
    private JTextField nameField, korField, engField, matField;
